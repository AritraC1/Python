...
### Adding Elements - 1. append() adds an element at the end, 2. insert() adds an element at a specific index
numbers.append(60)
...
### Removing Elements - 1. remove(): removes the first matching value, 2. pop(): removes by index and returns the element, del keyword can also be used
numbers.remove(40)
